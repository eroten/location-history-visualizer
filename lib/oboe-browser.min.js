! function(a, b, c, d, e, f) {
      ...
      if (!i) {
        ...
        for (j = a[0]; j && (k = j, j = a[d++]);) switch (Y++, "\n" == j ? ($++, Z = 0) : Z++, T) {
          case s:
            ...
            else if (!g(j)) return c("Non-whitespace before {[.");
            continue;
          case z:
          case u:
            if (g(j)) continue;
          ...
          case v:
            if (g(j)) continue;
            if (":" === j) T === v ? (U.push(v), P && (m({}), l(P), P = ""), X++) : P && (l(P), P = ""), T = t;
            else if ("}" === j) P && (m(P), n(), P = ""), n(), X--, T = U.pop() || t;
            else {
  ...
  function P(a, b) {
    ...
    var p, r = /^(node|path):./,
      ...
      w = function(b, c, d) {
        if ("done" == b) s.un(c);
        else if ("node" == b || "path" == b) a.un(b + ":" + c, d);
        else {
          var e = c;
          a(b).un(e)
        }
